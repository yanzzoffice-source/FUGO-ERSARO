-- ============================================
-- TOOLS FUGO ERSARO v3.0
-- Full Utility Suite | Luna Interface
-- Izin Developer: DIDAPATKAN
-- ============================================
...
MobTab:CreateToggle({
    ...
    Callback = function(v)
        ...
        if char and char:FindFirstChild("Humanoid") then
            char.Humanoid.JumpPower = v and jumpPower or 50
        end
    end
}, "JumpBoost")
...
local function initCoords()
    ...
    coordLabel.Size = UDim2.new(0, 320, 0, 22)
...
LocTab:CreateToggle({
    ...
    CurrentValue = true,
    Callback = function(v) coordOn = v end
}, "ShowCoords")
...
local locDropdown = LocTab:CreateDropdown({
    ...
    Options = locOptions,
    CurrentOption = {"No saved locations"},
...
LocTab:CreateButton({
    ...
    Callback = function()
        ...
        for _, loc in ipairs(savedLocs) do
            if loc.GameId == gameId then
                table.insert(locOptions, loc.Name)
            end
        end
        if #locOptions == 0 then locOptions = {"No saved locations"} end
        print("📍 RECORDED: " .. name .. " | Vector3.new(" .. math.floor(p.X) .. "," .. math.floor(p.Y) .. "," .. math.floor(p.Z) .. ")")
    end
})
...
LocTab:CreateButton({
    ...
    Callback = function()
        savedLocs = {}
        locOptions = {"No saved locations"}
        print("🗑️ All locations cleared!")
    end
})
    ...
    Callback = function(v)
        ...
        if v then
            ...
            if char and char:FindFirstChild("HumanoidRootPart") then
                ...
                flyBV.MaxForce = Vector3.new(4000,4000,4000); flyBV.P = 1000
                flyBV.Parent = root
...
ExpTab:CreateDropdown({
    Name = "ESP Mode",
    Options = {"Box", "Full", "Health", "Hitbox", "NPC"},
    CurrentOption = {"Full"},
    MultipleOptions = false,
    Callback = function(v) espMode = v end
}, "ESPMode")
...
local function initPingFps()
    ...
    fpsText.Parent = frame; fpsText.BackgroundTransparency = 1
    ...
    pingText.Parent = frame; pingText.BackgroundTransparency = 1
...
VisTab:CreateToggle({
    Name = "Ping & FPS Monitor",
    CurrentValue = true,
    Callback = function(v) pingFpsOn = v end
}, "PingFps")
...
VisTab:CreateButton({
    ...
    Callback = function()
        ...
        Lighting.Ambient = Color3.fromRGB(255,220,200)
...
VisTab:CreateButton({
    ...
    Callback = function()
        ...
        Lighting.Ambient = Color3.fromRGB(120,220,255)
...
VisTab:CreateButton({
    ...
    Callback = function()
        ...
        Lighting.Ambient = Color3.fromRGB(170,240,255)
        Lighting.FogEnd = 100000; Lighting.FogStart = 100000
 ...
 VisTab:CreateButton({
    ...
    Callback = function()
        ...
        if terrain then
            terrain.WaterReflectance = 0.35; terrain.WaterTransparency = 0.15
            terrain.WaterWaveSize = 0.12; terrain.WaterWaveSpeed = 18
            terrain.WaterColor = Color3.fromRGB(80,170,255)
        end
...
-- FINAL
-- ============================================
print("✅ TOOLS FUGO ERSARO v3.0 LOADED!")
print("🟢 All 25+ features ready!")
